...
const Chat = ({handleChat, showChat}) => {
  ...
  const [recommended, setRecommended] = useState(['What are you?','Who is Adrian?','What does he do?','Does he have work experience?']);
  ...
  return (
    <section>
      <div className="flex flex-col gap-2 m-auto border border-neutral-500/20 p-4 rounded-md mr-4 bg-zinc-900 bg-opacity-95">
        ...
        >
          {messages.length == 0 &&
            <div className="text-sm text-zinc-500 text-center px-12 pt-2">
              <p>These messages are generated by AI, some of the information provided may not be completely correct.</p>
            </div>}
        ...
        <form className="flex items-center" onSubmit={handleSubmit}>
          <input
            ...
            type="text"
            name="question"
            placeholder="Ask me something about Adrian!"
            value={question}
          ...
          <button
            ...
            type="submit"
          >
            {loading ? <Loader className="animate-spin"/> : <SendHorizonal className="hover:scale-110"/>}
          </button>
        </form>
      </div>
    </section>
