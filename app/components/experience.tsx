...
export const Experience = () => {
    return (
        <div className="mt-16 animate-fade-in mx-[2rem] lg:mx-[4rem]" id='experience'>
                ...
                {experiences.map((experience, index) => (
                    <div key={experience.company} className="relative mt-6 text-start">
                        ...
                        <div className="pl-8 my-6">
                            <h3 className="text-lg text-zinc-100 font-bold">{experience.title}</h3>
                            <h4 className="text-sm text-white font-semibold">{experience.company}</h4>
